                    ...
                    <form method="POST" action='{{ env('APP_URL') }}register' id="form">
                          ...
                          <div class="user-name">
                                <div class="d-flex text">
                                    <p class="p-login">{{ __('register.name') }}</p class="circle"><p class="circle">.</p>
                                </div>
